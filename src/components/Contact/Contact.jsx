    ...
    return (
        <div id='contact' className='flex flex-col md:flex-row items-center justify-between w-[90%] m-auto mt-16 lg:mt-10'>
            <div className=' w-full lg:w-1/2 text-white flex flex-col justify-center items-start p-3 gap-3'>
                ...
                <Link to={'mailto:masumahmed64077@gmail.com'} className='lg:ml-10 font-bold text-lg  rounded-xl p-2 my-3 bg-[#ff5823] hover:bg-[#ffffff] hover:text-[#ff5823] border-2  hover:border-2 hover:border-[#ff5823] transition-all duration-300 capitalize'>contact with me</Link>
            </div>
